...
use winapi::um::winuser::{OpenClipboard, CloseClipboard, GetClipboardData, SetClipboardData, EmptyClipboard, CF_UNICODETEXT};
use winapi::um::winbase::{GlobalLock, GlobalUnlock, GlobalAlloc, GMEM_MOVEABLE};
